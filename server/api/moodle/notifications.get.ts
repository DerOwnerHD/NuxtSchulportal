...
import { MoodleNotification, lookupSchoolMoodle, transformMoodleNotification } from "../../moodle";
...
export default defineEventHandler(async (event) => {
    ...
    const query = getQuery<{ session: string; cookie: string; paula: string; school: string; user: string }>(event);
